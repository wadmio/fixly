...
**Fixly: Scan Current Project** from the command palette (or **Fixly: Apply Remediation Plan** to
write fixes behind a diff preview). The report opens in a webview; logs go to the "Fixly" output
channel.
