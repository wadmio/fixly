...
const features = [
  ...
  },
  {
    ...
    description:
      "Designed around your workflow. Results map directly to packages and the exact version to upgrade to.",
  },
];
...
const stats = [
  { value: "OSV", label: "Live data source" },
  { value: "npm", label: "Ecosystem" },
  { value: "Public repos", label: "Scan target" },
];
